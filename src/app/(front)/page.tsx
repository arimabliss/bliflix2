    ...
    <>
      ...
      >
        <Link href="/home">
          ...
          <span className="sr-only">Go to KoWatch</span>
        </Link>
        ...
        <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
          A cleaner streaming shell with sharper visuals, better episode flow,
          and fast watch-party handoff when you want to sync up with friends.
        </p>
        <div className="space-x-4">
          <Link className={`${buttonVariants({ size: "lg", className: "soft-shine bg-[image:var(--gradient-primary)] text-slate-950 hover:opacity-95" })}`} href="/home">
